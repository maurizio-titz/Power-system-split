...
from utils.config import path_to_evaluation_results, path_to_pypsa_network_sclopf
...
n_nodes_split, lost_load_share = 400, 0.01
...
for indicator_type, transformation in indicator_type_transformation:
    ...
    network = data_handling.load_pypsa_network(
        ...
        + f"sclopf-elec_s_{n_nodes}_ec_lv1.0_Co2L{0.5}-2920SEG.nc",
        True,
    )
